/* eslint-disable quality/max-lines, import-x/no-restricted-paths, max-lines-per-function, @typescript-eslint/no-explicit-any, quality/no-direct-console, max-statements */ // FIXME: D�vida t�cnica (Quarentena)
